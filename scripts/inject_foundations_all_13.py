#!/usr/bin/env python3
"""
Inject expanded content for ALL 13 short Foundations lessons into DB.
"""
import os
import psycopg2
...
# All 13 short Foundations lessons with expanded content
lessons = [
    ('foundations', 'history-of-the-bar', 'ancient-fermentation',
     ...
     """Fermentation is one of the oldest chemical processes humans have controlled, dating back to at least 7000–6600 BCE in Jiahu, China, where residue analysis revealed a mixed fermented drink of rice, honey, and fruit. In Mesopotamia, the Sumerians brewed beer from barley by 4000 BCE — the Hymn to Ninkasi is both a prayer and a beer recipe, making it the oldest known written recipe in human history.

Distillation emerged much later, likely between 1st century CE Alexandria and 8th–9th century Arabia, where alchemists refined wine into stronger spirits for medicinal use. The word "alcohol" comes from the Arabic al-kuhl, referring to a fine powder used as eyeliner, which became associated with distilled essences. Monasteries across Europe became centers of distillation knowledge by the 12th century, producing herbal tinctures and aqua vitae, the "water of life."

Understanding this timeline matters for bartenders because every spirit you pour carries this history. When you serve mezcal, you are serving a tradition that predates Spanish distillation in Mexico, where indigenous peoples fermented agave for centuries before copper stills arrived. When you serve cognac, you are serving a product of 16th-century monastic experimentation. Knowing the "why" behind the drinks helps you tell their stories to guests, and storytelling is half of modern bartending."""),
...
A jigger (double-ended, 1oz/2oz or ¾oz/1½oz) ensures consistent pours. The smaller end is for liqueurs and modifiers; the larger end is for spirits. Some bartenders use a Japanese-style jigger with multiple measurement marks for extra precision. Free-pouring without a jigger is acceptable only after you have built muscle memory with one — and even then, keep a jigger behind the bar for verification."""),
    ...
    ('foundations', 'bar-setup-terminology', 'measurements',
     'Bar Measurements',
     'Oz, ml, dash, splash, barspoon — and the metric conversion.', '12 min', 'Beginner',
     """Consistency is impossible without standardized measurement. Every cocktail is a ratio, and ratios only work if the parts are the same size every time.
...
Taste in a quiet room with minimal background smells. Coffee, cigarette smoke, strong food aromas, and even strong perfumes will distort your perception. Serious tasting rooms are designed for this: neutral walls, clean glassware, no competing odours."""),
    ...
    ('foundations', 'palate-training', 'how-alcohol-affects-flavour-perception',
...
Training your palate means learning to identify these tastes in isolation, then in combination. Taste lemon juice and identify the sour. Taste tonic water and identify both sweet and bitter. Taste a well-made margarita and identify all five at once."""),
    ...
    ('foundations', 'palate-training', 'training-your-nose',
     'Training Your Nose',
     'Aroma families and olfactory memory.', '14 min', 'Beginner',
     """Smell is 80% of flavor, yet most people never train their nose beyond recognizing coffee and garbage. For a bartender, olfactory skill is a professional advantage — it lets you identify spirits by aroma alone, spot off notes before they reach a guest, and create cocktails that smell as complex as they taste.
...
Finally, connect smell to memory. When you smell elderflower for the first time, link it to something you already know: "elderflower smells like lychee and pear with a hint of cucumber." When you taste mezcal, link the smoke to campfire and roasted agave. Association is the fastest way to build a mental library of aromas."""),
    ...
    ('foundations', 'palate-training', 'building-flavour-memory',
     'Building Flavour Memory',
     'How to remember and recall flavours.', '14 min', 'Beginner',
     """Memory is associative, and flavour memory is no exception. The fastest way to build a mental library of tastes and aromas is to link every new flavour to something you already know.

When you taste lime juice, do not just file it as "citrus." Link it: lime equals key lime pie, margaritas, Thai green curry, Sprite, the zest on a gin and tonic. When you taste Campari, link it to the Negroni you had last week, the Boulevardier your friend made, the Campari soda at the bar downtown. The more associations you create, the faster you will recognize that flavour in a new context.

Build a mental map of flavour families. "Citrus + herbal + bitter" points toward gin. "Caramel + vanilla + oak" points toward bourbon. "Molasses + tropical fruit + funk" points toward Jamaican rum. "Floral + grape + stone fruit" points toward aromatic white wine. These are not rules, they are heuristics that help you predict what you are about to taste and design cocktails that will work.

Deliberate practice beats passive exposure. Tasting deliberately means setting aside five minutes during prep to nose a new spirit, compare two vermouths side by side, or chew on a strip of orange peel and name three aromas. Passive exposure — drinking a margarita while watching TV — creates far weaker memories. The goal is not to become a sommelier, it is to build enough reference points that you can troubleshoot a cocktail in seconds.

Taste in context. Aroma changes with temperature, dilution, and mixing. Taste a bourbon neat, then with a few drops of water, then in a Manhattan. Notice how each stage reveals different compounds: the high, floral notes fade with dilution; the vanilla and oak persist; the "burn" recedes. Contextual tasting teaches you how ingredients behave in actual cocktails, not just in a tasting glass.

Revisit regularly. Memory fades without reinforcement. Schedule monthly tastings of the same spirit or ingredient — a "library session." Compare the bourbon you tasted last month to the new bottle you just opened. Has the flavour shifted? Has your perception shifted? Both are useful data. Over time, you will notice that your own palate is changing as much as the products you taste.

Finally, teach what you learn. Explaining a flavour to a guest or a trainee forces you to articulate it clearly, which strengthens the memory. "This gin has a lot of coriander and a hint of cucumber" is a more precise and more useful description than "it tastes like gin."""),
]
