...
sources: ["diffordsguide", "liquor-com", "clover-club", "69-colebrooke-row", "lyaness"]
images:
  - path: /photos/modernist-cocktails-hero.svg
    alt: Modernist cocktail revolution hero with flask and molecule network
    usage: cover
  - path: /photos/modernist-molecule-diagram.svg
    alt: Modernist molecule network diagram
    usage: inline
---
