...
export default function CocktailIcon({ iconType = 'martini', size = 200, className = '' }: CocktailIconProps) {
...
function iconFor(type: string, c: { glass: string; stroke: string; liquid: string }): React.ReactNode {
  switch (type) {
    case 'martini':
      return (
        <g>
