...
-- Croatian-language lesson translations (parity with lessons)
...
DROP TRIGGER IF EXISTS lessons_hr_updated ON lessons_hr;
...
CREATE INDEX IF NOT EXISTS idx_lessons_hr_technique ON lessons_hr(technique_id);
