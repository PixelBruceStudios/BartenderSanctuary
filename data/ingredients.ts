...
export const ingredients: Ingredient[] = [
 ...
 ,
  ...
  bottles: [
    ...
    { name: "Bitter Truth Aromatic Bitters", description: "German-made aromatic bitters. Similar herbal profile to Angostura with gentian root, spices, and herbs. 39% ABV. A quality alternative for stirred cocktails.", related: ["Peychaud's Aromatic Bitters", "Angostura Aromatic Bitters"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Peychauds.jpg" },
    { name: "Scrappy's Aromatic Bitters", description: "American craft aromatic bitters. Bright, complex profile with citrus and spice notes. A versatile modifier for cocktails calling for Peychaud's or Angostura.", related: ["Peychaud's Aromatic Bitters", "Bittermens Boston Bitters"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Peychauds.jpg" },
    { name: "Fee Brothers Old Fashioned Bitters", description: "American aromatic bitters from Fee Brothers with notes of allspice, clove, and citrus peel. A classic aromatic bitters for Old Fashioneds and Manhattan variations.", related: ["Peychaud's Aromatic Bitters", "Bitter Truth Aromatic Bitters"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Peychauds.jpg" },
    { name: "Bittermens Boston Bitters", description: "Small-batch aromatic bitters from Bittermens. Baking spice, dried citrus, and tea-like tannins. A versatile modifier for stirred cocktails and spirit-forward drinks.", related: ["Peychaud's Aromatic Bitters", "Fee Brothers Bitters", "Angostura Bitters"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Peychauds.jpg" }
  ]
},
