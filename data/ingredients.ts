...
export const ingredients: Ingredient[] = [
  ...
  bottles: [
        { name: "Cointreau", description: "Premium French triple sec. Clean orange flavor, 40% ABV, dry finish. The standard for classic cocktails.", related: ["Combier", "Marie Brizard Triple Sec", "Bols Triple Sec"], image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Cointreau_bottle.jpg/320px-Cointreau_bottle.jpg" },
