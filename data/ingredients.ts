...
export const ingredients: Ingredient[] = [
  ...
  { name: "Blended Scotch", category: "Whiskies", description: "Same as blended scotch — kept as separate entry because it appeared in recipe text with capital S.", brands: ["Johnnie Walker Black", "Chivas Regal 12", "Ballantine's"], notes: "Deduplicated with Blended scotch at runtime.", bottles: [
    ...
    { name: "Johnnie Walker Red Label", description: "The original Johnnie Walker blend. Bold, fiery, and versatile. Designed for mixing in highballs and cocktails — not meant for sipping neat.", related: ["Johnnie Walker Black Label", "Johnnie Walker Gold Label", "Johnnie Walker Blue Label"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Johnnie_Walker_Red_Label_Blended_Scotch_Whisky_01.jpg" },
    { name: "Teacher's Highland Cream", description: "Classic blended Scotch whisky from Scotland. Smooth, approachable, with honey, vanilla, and subtle spice. An affordable, reliable mixer for highballs and long drinks.", related: ["Dewar's 12 Year", "Ballantine's Finest", "The Famous Grouse"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Teacher%27s_Highland_Cream_20cl_bottle_2.jpg" },
    { name: "Clan Campbell", description: "Blended Scotch whisky from Scotland. Smooth, balanced, with honey, vanilla, and gentle oak. A reliable, affordable mixer for everyday cocktails.", related: ["Johnnie Walker Red Label", "Ballantine's Finest", "The Famous Grouse"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Bouteille_Clan_Campbell.png" }
  ]},
  ...
  ,
    ...
    { name: "Ardbeg Corryvreckan", description: "Vividly peated Ardbeg with dark chocolate, aniseed, and apple smoke. Less medicinal than Ardbeg 10 but equally complex. The name comes from a whirlpool off Islay's coast.", related: ["Ardbeg 10", "Ardbeg Uigedail", "Ardbeg An Oa"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ardbeg_Corryvreckan.jpg" },
    { name: "Ardbeg An Oa", description: "Ardbeg's voyage to the sea between Islay and Jura. Peat smoke meets vanilla, honey, and tropical fruit. A smoother, more approachable Ardbeg for those new to Islay.", related: ["Ardbeg 10", "Ardbeg Corryvreckan", "Ardbeg Uigedail"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ardbeg_An_Oa.jpg" },
    { name: "Bowmore 18 Year", description: "18-year-old Islay single malt with elegant peat smoke, dried fruit, dark chocolate, and a hint of orange zest. A refined, complex dram showcasing Bowmore's maturation expertise.", related: ["Bowmore 12", "Bowmore 15", "Lagavulin 16"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Bowmore_Islay_Single_Malt_18.jpg" },
    { name: "Bruichladdich Octomore", description: "Bruichladdich's super-peated Octomore series. Among the most heavily peated whiskies in the world, yet balanced with citrus, vanilla, and coastal brine. A benchmark for extreme peat lovers.", related: ["Bruichladdich Scottish Barley", "Port Charlotte Scottish Barley", "Bruichladdich The Classic Laddie"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Octomore_6.2_Islay_Single_Malt_Scotch_Whisky.jpg" }
  ]
},
  { name: "Irish whiskey", category: "Whiskies", description: "Triple-distilled Irish whiskey, typically lighter and smoother than Scotch with notes of honey, vanilla, and green apple.", brands: ["Jameson", "Bushmills Original", "Redbreast 12", "Tullamore D.E.W.", "Green Spot"], notes: "Key for Irish Coffee, Tipperary, Forty-Three.", bottles: [
    ...
    { name: "Jameson Black Barrel", description: "Double-matured Irish whiskey from Jameson. Aged in former bourbon barrels then finished in double-charred oak barrels. Rich, with notes of dark chocolate, toasted wood, and dried fruit. A premium sipper and cocktail whiskey.", related: ["Jameson", "Jameson Caskmates", "Redbreast 12"] },
    { name: "Green Spot", description: "Single pot still Irish whiskey from Midleton Distillery. Non-age-stated but typically 7-10 years. Fresh, fruity, with barley, vanilla, and spice. One of the few remaining single pot still whiskeys without an age statement.", related: ["Yellow Spot", "Redbreast 12", "Powers Gold Label"] },
    { name: "Bushmills 10 Year", description: "Single malt Irish whiskey from Bushmills Distillery. Aged 10 years in ex-bourbon and Oloroso sherry casks. Rich, with notes of honey, dark chocolate, and toasted oak. A step up from Bushmills Original for sipping or cocktails.", related: ["Bushmills Original", "Bushmills 16", "Jameson"] },
    { name: "Kilbeggan Irish Whiskey", description: "Irish whiskey from the Kilbeggan Distillery in Westmeath, Ireland. Triple-distilled, smooth, with honey, vanilla, and spice. A modern expression from one of Ireland's oldest distilleries (founded 1757).", related: ["Jameson", "Bushmills Original", "Tullamore D.E.W."], },
    { name: "Powers John's Lane", description: "Premium single pot still Irish whiskey from John Powers & Co. Rich, spicy, with notes of apple, pepper, toasted oak, and dried fruit. A flagship expression of the Powers range, matured in ex-bourbon and sherry casks. 46% ABV.", related: ["Powers Gold Label", "Jameson", "Redbreast 12"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Powers_John%27s_Lane_Irish_Whiskey.jpg" },
    { name: "Midleton Very Rare", description: "Ultra-premium blended Irish whiskey from Midleton Distillery. A complex blend of the distillery's finest pot still and malt whiskeys, aged in ex-bourbon and sherry casks. Rich, smooth, with notes of honey, vanilla, dried fruit, and toasted oak. 40% ABV. The pinnacle of Midleton's range.", related: ["Redbreast 12", "Jameson", "Powers Gold Label"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Midleton_Very_Rare.jpg" },
    { name: "Teeling Small Batch", description: "Small batch Irish whiskey from Teeling Distillery in Dublin. A blend of grain and malt whiskeys matured in ex-bourbon, ex-rum, and ex-wine casks. Smooth, sweet, with notes of vanilla, caramel, and tropical fruit. 46% ABV. A modern Dublin classic.", related: ["Jameson", "Bushmills Original", "Tullamore D.E.W."], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Teeling_Irish_Whiskey.jpg" },
    { name: "Yellow Spot", description: "Single pot still Irish whiskey from Midleton Distillery. Non-age-stated but typically 12 years. Matured in a combination of ex-bourbon, sherry, and Malaga wine casks. Rich, complex, with notes of honey, vanilla, dried fruit, and spice. A richer sibling to Green Spot.", related: ["Green Spot", "Redbreast 12", "Powers Gold Label"] },
    { name: "Powers Three Swallow", description: "Irish single pot still whiskey from John Powers & Co. Rich, spicy, with notes of apple, pepper, and toasted oak. A classic expression from one of Ireland's oldest whiskey brands. 43% ABV. A versatile mixer and sipper.", related: ["Powers Gold Label", "Jameson", "Redbreast 12"] },
  ] },
  ...
  ,
    ...
    { name: "Jameson Rye", description: "Irish rye whiskey from Jameson Distillery in Ireland. Triple-distilled with a blend of malt and grain whiskies aged in ex-bourbon and sherry casks. Smooth, spicy, with pepper, vanilla, and honey. A versatile crossover rye for Manhattan and highball cocktails.", related: ["Jameson", "Bushmills Original", "Redbreast 12"] },
    { name: "Wild Turkey Rare Breed", description: "High-rye Kentucky bourbon from Wild Turkey Distillery. Bottled at 112.8 proof unfiltered. Bold, complex, with caramel, vanilla, oak, and a peppery finish. A powerful mixer for Boulevardier and old-fashioned variations.", related: ["Wild Turkey 101", "Wild Turkey Rye", "Buffalo Trace"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Wild_Turkey_Rare_Breed.jpg" },
    { name: "Old Rip Van Winkle", description: "Kentucky straight bourbon from Old Rip Van Winkle Distillery. Aged 10 years. Rich, smooth, with caramel, vanilla, oak, and baking spice. 90.4 proof. A highly sought-after wheated bourbon for premium cocktails.", related: ["Pappy Van Winkle", "Weller Bourbon", "Buffalo Trace"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Old_Rip_Van_Winkle_Whiskey_301243232.jpg" },
    { name: "Colonel E.H. Taylor Straight Rye", description: "Premium straight rye whiskey from Buffalo Trace Distillery in Kentucky. Aged in new charred oak barrels. Bold, spicy, with pepper, cinnamon, and vanilla. A historic label honoring Edmund Haynes Taylor. A refined, full-flavored rye for Manhattan and Sazerac.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Old_Overholt_RyeWhiskey_bottle.jpg" }
  ,
    { name: "Jefferson's Rye Whiskey", description: "Aged rye whiskey from Jefferson's Bourbon. Maritime-aged in Caribbean rum barrels for a unique twist on rye. Smooth, with pepper, vanilla, and tropical notes from the rum cask finish.", related: ["Rittenhouse Rye", "Bulleit Rye"], }
  ,
    { name: "Sagamore Spirit Rye", description: "Maryland-style rye whiskey from Sagamore Spirit Distillery. Double-cut rye mash bill aged in new American oak. Bold, spicy, with pepper, clove, and caramel. A modern craft rye for Manhattan and Boulevardier.", related: ["Rittenhouse Rye", "Bulleit Rye"], }
  ,
    { name: "Pike Creek Rye", description: "Canadian rye whisky from Pike Creek Distillery in Ontario. Aged in oak barrels with a smooth, approachable profile. Light spice with vanilla and caramel notes. An easy-mixing option for cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye"], }
  ,
    { name: "Crown Royal North Grid Rye", description: "Canadian rye whisky from Crown Royal. Smooth, with spice, vanilla, and oak. The North Grid expression celebrates northern craftsmanship. Versatile for mixing in Manhattan, Boulevardier, and other rye-forward cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Old_Overholt_RyeWhiskey_bottle.jpg" }
  ,
    { name: "Westland Rye Whiskey", description: "American craft rye whiskey from Westland Distillery in Seattle. Made with Pacific Northwest malted barley and rye. Unique malt-forward profile with spice, earth, and orchard fruit notes. A distinctive craft whiskey for sipping or cocktails.", related: ["Rittenhouse Rye", "High West Rye"] },
    { name: "Forty Creek Small Batch", description: "Canadian craft whisky from Forty Creek Distillery in Ontario. Small-batch, triple-aged in ex-bourbon, sherry, and wine casks. Rich, with spice, vanilla, dried fruit, and a hint of Canadian oak. A versatile rye-forward whisky for Manhattan and Old Fashioned.", related: ["Rittenhouse Rye", "Bulleit Rye", "Alberta Premium Canadian Rye Whisky"] },
    { name: "Lot No. 40 Canadian Whisky", description: "Premium Canadian whisky from Lot No. 40 Distillery. Crafted in small batches with a high-rye mash bill aged in new oak barrels. Bold, spicy, with pepper, cinnamon, and caramel. An artisanal Canadian rye for Manhattan and Boulevardier.", related: ["Rittenhouse Rye", "Alberta Premium Canadian Rye Whisky", "Crown Royal Black"] },
    { name: "Alberta Premium Canadian Rye Whisky", description: "Iconic Canadian rye whisky from Alberta Distillers. Bold, spicy, with pepper, cloves, and a smooth vanilla finish. The quintessential Canadian rye for Caesars and Whisky Sours.", related: ["Rittenhouse Rye", "Canadian Club 100% Rye", "Crown Royal Black"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Alberta_premium.jpg" },
    { name: "Canadian Club 100% Rye", description: "Canadian rye whisky from Canadian Club. Made from 100% rye grain, aged in oak barrels. Smooth, approachable, with spice, vanilla, and a clean finish. A reliable, widely available rye for highballs and mixing.", related: ["Rittenhouse Rye", "Alberta Premium Canadian Rye Whisky", "Crown Royal Black"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Canadian_Club_1.14L%2C_Canada_%28obverse%29%2C_2026-03-11.jpg" },
    { name: "Crown Royal Black", description: "Premium Canadian whisky from Crown Royal. A darker, bolder expression of the classic Crown Royal blend. Rich, with spice, vanilla, oak, and a smooth full body. The black bag packaging makes it a recognizable gift bottle. Great for Manhattan or neat sipping.", related: ["Rittenhouse Rye", "Alberta Premium Canadian Rye Whisky", "Canadian Club 100% Rye"] },
    { name: "WhistlePig PiggyBack Rye", description: "6-year-aged rye whiskey from WhistlePig Distillery in Vermont. Made with 100% rye grains and designed for mixing in cocktails. Smooth, with pepper, vanilla, and a hint of oak. A more accessible, cocktail-focused expression from WhistlePig.", related: ["WhistlePig 10 Year", "WhistlePig 12 Year", "Rittenhouse Rye"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/WhistlePig_bottle.jpg" },
    { name: "George Dickel Rye", description: "American rye whiskey from George Dickel Distillery in Tennessee. Sourced from MGP and filtered through charcoal for a smooth, clean profile. Spicy, with pepper, vanilla, and a hint of oak. A reliable, widely available rye for Manhattan and Boulevardier.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"] },
    { name: "Wilderness Trail Rye", description: "Kentucky straight rye whiskey from Wilderness Trail Distillery. Small-batch, with a high-rye mash bill aged in new charred oak. Bold, spicy, with pepper, cinnamon, and caramel. A craft favorite for sipping and cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "Pikesville Rye"] },
    { name: "Barrell Rye", description: "Blended rye whiskey from Barrell Craft Spirits. A combination of rye whiskeys aged in various barrels, bottled at cask strength. Rich, complex, with spice, vanilla, dried fruit, and oak. A highly allocated, small-batch rye for spirit-forward cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"] },
    { name: "Crown Royal Northern Harvest Rye", description: "Canadian rye whisky from Crown Royal. Made with 100% rye grain, offering a smooth, spicy profile with vanilla and oak notes. A widely available Canadian rye for mixing in Manhattan and Old Fashioned cocktails.", related: ["Crown Royal Black", "Alberta Premium Canadian Rye Whisky", "Canadian Club 100% Rye"] },
    { name: "Koval Single Barrel Rye", description: "American rye whiskey from Koval Distillery in Chicago. Single barrel, unfiltered, with a bold spicy profile of pepper, cinnamon, and dried fruit. A craft favorite for sipping and cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "WhistlePig 10 Year"] },
    { name: "Redemption Rye Whiskey", description: "American rye whiskey from Redemption Spirits. High-rye mash bill aged in new charred oak barrels. Bold, spicy, with pepper, clove, and vanilla. A classic cocktail rye for Manhattan and Sazerac.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"] },
    { name: "Wiser's Red Letter", description: "Canadian rye whisky from J.P. Wiser's Distillery. Small-batch, aged in oak barrels with a rich, spicy profile of pepper, vanilla, and caramel. A premium Canadian rye for sipping and mixing.", related: ["Crown Royal Black", "Alberta Premium Canadian Rye Whisky", "Lot No. 40 Canadian Whisky"] },
    { name: "Basil Hayden's Rye", description: "Small-batch rye whiskey from Basil Hayden's Distillery in Kentucky. Aged in oak barrels with a smooth, spicy profile of pepper, vanilla, and caramel. A premium, lighter rye for sipping and cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"] },
    { name: "Knob Creek Rye", description: "Kentucky straight rye whiskey from Knob Creek Distillery. Aged in charred oak barrels with a bold, spicy profile of pepper, cinnamon, and vanilla. 100 proof for a robust cocktail presence.", related: ["Rittenhouse Rye", "Bulleit Rye", "Wild Turkey Rye"] },
    { name: "Starward Rye", description: "Australian rye whiskey from Starward Distillery in Melbourne. Matured in Australian oak barrels with a unique profile of spice, vanilla, and tropical fruit notes. A distinctive craft rye for modern cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "High West Rye"] },
    { name: "Few Spirits Rye", description: "American rye whiskey from Few Spirits Distillery in Evanston, Illinois. Small-batch, unfiltered, with a bold spicy profile of pepper, cinnamon, and dried fruit. A craft favorite for spirit-forward cocktails.", related: ["Rittenhouse Rye", "Bulleit Rye", "WhistlePig 10 Year"] },
    { name: "Smooth Ambler Rye", description: "American rye whiskey from Smooth Ambler Distillery in West Virginia. Small-batch, with a high-rye mash bill aged in new charred oak. Bold, spicy, with pepper, clove, and caramel. A craft staple for Manhattan and Boulevardier.", related: ["Rittenhouse Rye", "Bulleit Rye", "Pikesville Rye"] }
  ] },
  { name: "Bourbon", category: "Whiskies", description: "American whiskey made with at least 51% corn, aged in new charred American oak. Sweet vanilla, caramel, and oak notes.", brands: ["Buffalo Trace", "Maker's Mark", "Woodford Reserve", "Bulleit Bourbon", "Wild Turkey 101", "Four Roses Small Batch"], notes: "Versatile: Mint Julep, Old Fashioned, Whiskey Sour, Boulevardier.", bottles: [
    ...
    { name: "Jefferson's Small Batch Bourbon", description: "Kentucky straight bourbon from Jefferson's. Aged in new charred oak with a balanced profile of caramel, vanilla, and oak. A well-rounded small-batch bourbon for Old Fashioneds and Manhattans.", related: ["Buffalo Trace", "Wild Turkey 101", "Maker's Mark"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Jefferson%27s_Small_Batch_Bourbon.jpg" },
    { name: "Yellowstone Bourbon", description: "Kentucky straight bourbon from Yellowstone. Rich vanilla, caramel, and oak with a smooth finish. A classic bourbon for Mint Julep and Whiskey Sour.", related: ["Buffalo Trace", "Wild Turkey 101", "Maker's Mark"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Yellowstone_Burbon_Crop.jpg" },
    { name: "Rowan's Creek Bourbon", description: "Kentucky straight bourbon from Rowan's Creek. Bold, full-bodied, with deep caramel, vanilla, and oak. A small-batch bourbon with a robust profile for spirit-forward cocktails.", related: ["Buffalo Trace", "Wild Turkey 101", "Maker's Mark"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Rowanscreek.jpg" },
  ] },
  { name: "Bourbon or rye", category: "Whiskies", description: "Either bourbon or rye whiskey depending on preference. Bourbon = sweeter; rye = spicier/drier.", brands: ["Buffalo Trace", "Rittenhouse Rye"], notes: "Manhattan flexibility.", bottles: [
    ...
    { name: "Blanton's Single Barrel", description: "Kentucky straight bourbon from Buffalo Trace Distillery. Bottled from a single barrel, each bottle numbered. Rich caramel, vanilla, and oak with a spicy finish. Highly allocated — the unicorn bottle for every home bar.", related: ["Buffalo Trace", "Wild Turkey Rare Breed", "Elijah Craig Small Batch"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Blanton%27s_Bourbon.jpg" },
    { name: "Wild Turkey Rare Breed", description: "Kentucky straight bourbon from Wild Turkey. Non-chill filtered, bottled in bond at 116.8 proof. Bold, complex, with deep caramel, vanilla, and oak. A premium choice for spirit-forward cocktails.", related: ["Wild Turkey 101", "Buffalo Trace", "Knob Creek 9 Year"] },
    { name: "Evan Williams Single Barrel", description: "Kentucky straight bourbon from Evan Williams. Single-barrel expression with rich caramel, vanilla, and toasted oak. A value-priced premium option for Old Fashioneds and Manhattans.", related: ["Buffalo Trace", "Wild Turkey 101", "Old Forester 86"] },
    { name: "Old Rip Van Winkle", description: "Kentucky straight bourbon wheated whiskey from Old Rip Van Winkle Distillery. Aged 10 years. Smooth, sweet, with caramel, vanilla, and baking spice. A highly sought-after wheated bourbon for premium cocktails.", related: ["Buffalo Trace", "Wild Turkey 101", "Maker's Mark"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Old_Rip_Van_Winkle_Whiskey_301243232.jpg" },
    { name: "Jim Beam Bourbon", description: "Kentucky straight bourbon from Jim Beam. Made with winter wheat for a soft, sweet profile of caramel, vanilla, and oak. The widely available everyday bourbon for high-volume bars and home mixing.", related: ["Buffalo Trace", "Wild Turkey 101", "Maker's Mark"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Jim_Beam_Kentucky_Straight_Bourbon_(2025-12-19).jpg" }
  ]
 },
  ...
  { name: "Brandy or Cognac", category: "Brandy & Cognac", description: "Cognac is a specific type of brandy from the Cognac region of France, always double-distilled in copper pot stills.", brands: ["Remy Martin VSOP", "Hennessy VS", "Martell Cordon Bleu", "Courvoisier VS"], notes: "Cognac gives richer fruit notes in Brandy Alexander, Sazerac variation.", bottles: [
    ...
    { name: "Hennessy VSOP", description: "Popular VSOP cognac. Smooth, with vanilla, spice, and toasted oak. A step up from VS for cocktails and sipping.", related: ["Hennessy VS", "Hennessy XO", "Remy Martin VS"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/2023_Hennessy_V.S._Cognac.jpg" },
    { name: "Martell Cordon Bleu", description: "Iconic cognac from the world's oldest cognac house. Rich, complex, with dried fruit, vanilla, and spice. A benchmark luxury cognac.", related: ["Martell VSOP", "Martell XO", "Remy Martin VSOP"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Martell_Cognac_Cordon_Bleu.jpg" },
    { name: "Courvoisier VSOP", description: "Smooth VSOP cognac from Courvoisier. Balanced, with vanilla, dried fruit, and light oak. A versatile mixer for Sidecar and Brandy Alexander.", related: ["Courvoisier VS", "Courvoisier XO", "Remy Martin VSOP"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Courvoisier_bottles_VSOP_XO.jpg" },
    { name: "Meukow VS", description: "Cognac from Meukow. Smooth, with vanilla and dried fruit. A reliable VS-grade cognac for mixing.", related: ["Meukow VSOP", "Remy Martin VS", "Hennessy VS"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Meukow_VS_bottle.jpg" },
    { name: "E&J VSOP Brandy", description: "Popular American VSOP brandy. Smooth, sweet, with vanilla and oak. An affordable mixing brandy for cocktails and highballs.", related: ["E&J XO Brandy", "Christian Brothers Brandy", "Korbel Brandy"] }
  ] },
  { name: "Cognac", category: "Brandy & Cognac", description: "Fine French brandy from Cognac region. VS (very special, min 2 years), VSOP (min 4 years), XO (min 10 years).", brands: ["Remy Martin VS", "Hennessy VS", "Martell VS", "Courvoisier VS", "Remy Martin VSOP", "Hennessy VSOP"], notes: "Sidecar, Brandy Alexander, B&B.", bottles: [
    ...
    { name: "Courvoisier XO", description: "Premium XO cognac from Courvoisier. Rich, powerful, with dried fruit, vanilla, spice, and toasted oak. A luxurious expression for Sidecar or neat sipping.", related: ["Courvoisier VSOP", "Courvoisier VS", "Remy Martin XO"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Courvoisier_XO.JPG" },
    { name: "Remy Martin XO", description: "Premium XO cognac from Remy Martin. Rich, powerful, with dried fruit, vanilla, spice, and toasted oak. A luxurious, long-finish cognac for Sidecar or neat sipping.", related: ["Remy Martin VS", "Remy Martin VSOP", "Hennessy XO"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Remy_Martin_XO.JPG" },
    { name: "Frapin XO Grande Champagne", description: "XO cognac from Frapin in Grande Champagne. Rich, powerful, with dried fruit, vanilla, spice, and toasted oak. A single-estate expression from one of Cognac's finest crus.", related: ["Remy Martin XO", "Hennessy XO", "Martell XO"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Frapin_-_Johannes_Malling_bottle.JPG" }
  ] },
  ...
  bottles: [
    ...
    { name: "Arrow Apricot Brandy", description: "American apricot brandy from Arrow. Sweet, smooth, with natural apricot flavor. An affordable option for cocktails and mixed drinks.", related: ["Marie Brizard Apricot Brandy", "Bols Apricot Brandy", "DeKuyper Apricot Brandy"] },
    { name: "Di Amore Apricot Brandy", description: "Italian apricot brandy from Di Amore. Sweet, fruity, with authentic stone-fruit character. A versatile mixer for cocktails.", related: ["Marie Brizard Apricot Brandy", "Bols Apricot Brandy", "Rothman & Winter Apricot Brandy"] },
    { name: "Leroux Apricot Brandy", description: "American apricot brandy from Leroux. Sweet, smooth, with natural apricot flavor. A widely available mixing brandy.", related: ["Marie Brizard Apricot Brandy", "Bols Apricot Brandy", "DeKuyper Apricot Brandy"] },
    { name: "McGuinness Apricot Brandy", description: "Irish-American apricot brandy from McGuinness. Sweet, fruity, with warm stone-fruit notes. Good for cocktails and highballs.", related: ["Marie Brizard Apricot Brandy", "Bols Apricot Brandy", "DeKuyper Apricot Brandy"] },
    { name: "Rempy's Apricot Brandy", description: "American apricot brandy from Rempy's. Sweet, smooth, with natural apricot flavor. An affordable mixing brandy for cocktails.", related: ["Marie Brizard Apricot Brandy", "Bols Apricot Brandy", "Rothman & Winter Apricot Brandy"] }
  ]
},
  ...
  bottles: [
    ...
    { name: "Fuersteneck Kirschwasser", description: "Kirschwasser from the Schwarzwald (Black Forest) region of Germany. Traditional German cherry eau-de-vie with clean, pure cherry character and subtle almond notes. Distilled from locally grown sour cherries.", related: ["G.E. Massenez Kirsch", "Clear Creek Kirschwasser", "Kirsch de Fougerolles"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Fuersteneck_Kirschwasser.jpg" },
    { name: "2 Longuich-Kirsch", description: "German kirschwasser from Longuich in the Mosel region. Small-batch cherry eau-de-vie with dry, clean cherry character and mineral precision. A traditional expression from Germany's cherry-producing regions.", related: ["Fuersteneck Kirschwasser", "G.E. Massenez Kirsch", "Clear Creek Kirschwasser"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/2_Longuich-Kirsch_46DSC_0422_(45697677144).jpg" },
    { name: "Kirsch de Fougerolles", description: "French kirsch from the Fougerolles region in Haute-Saône. PGI-protected cherry eau-de-vie made from Griotte cherries. Dry, pure, with bright cherry fruit and subtle almond notes. The benchmark Fougerolles kirsch for cocktails and sipping.", related: ["G.E. Massenez Kirsch", "Clear Creek Kirschwasser", "Kirsch du Blanc"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/KirschFougerolles.JPG" },
    { name: "Bô Kirsch AOC Devoille", description: "French kirsch from the Fougerolles AOC region, produced by Distillerie Paul Devoille. Made from Griotte cherries. Dry, elegant, with pure cherry character and mineral precision. A respected craft expression from a historic distillery.", related: ["Kirsch de Fougerolles", "G.E. Massenez Kirsch", "Clear Creek Kirschwasser"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/B%C3%B4_Kirsch_AOC_Devoille.jpg" },
    ...
    { name: "Kirsch du Blanc", description: "French kirsch from the Demiot distillery in the Jura region. Historically produced cherry eau-de-vie with dry, clean cherry character and subtle almond notes. A traditional French kirsch for White Lady and Kirsch Royal cocktails.", related: ["G.E. Massenez Kirsch", "Clear Creek Kirschwasser", "Kirsch de Fougerolles"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Kirsch_du_Blanc.jpg" }
  ]
},
  ...
  ,
    { name: "Kirsch du Blanc", description: "French kirsch from the Demiot distillery in the Jura region. Historically produced cherry eau-de-vie with dry, clean cherry character and subtle almond notes. A traditional French kirsch for White Lady and Kirsch Royal cocktails.", related: ["G.E. Massenez Kirsch", "Clear Creek Kirschwasser", "Kirsch de Fougerolles"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Kirsch_du_Blanc.jpg" }
  ,
    { name: "Urschwyzer Kirsch", description: "Swiss kirsch from the original Swiss production region. Small-batch cherry eau-de-vie with clean, dry cherry character and mineral notes. A traditional Swiss expression for sipping and cocktails.", related: ["Distillerie de Neuchâtel Kirsch", "Etter Zuger Kirsch", "G.E. Massenez Kirsch"] }
  ]
},
  ...
  ,
    { name: "Appleton Estate Signature Blend", description: "Jamaican dark rum from Appleton Estate. Rich, smooth, with notes of molasses, tropical fruit, and oak. Versatile for Mai Tai, Dark 'n' Stormy, and aged rum cocktails.", related: ["Myers's Original Dark", "Gosling's Black Seal", "Plantation XO"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Appleton_Estate_Jamaica_Rum_01.jpg" },
    { name: "El Dorado 12 Year Special Reserve", description: "Guyanese dark rum aged 12 years. Deep molasses, caramel, vanilla, and spice with a smooth finish. Ideal for Mai Tai and Jungle Bird.", related: ["Flor de Caña 7", "Myers's Original Dark", "Gosling's Black Seal"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/El_Dorado_Rum.JPG" },
    { name: "Ron Zacapa 23", description: "Guatemalan solera-aged dark rum, aged up to 23 years. Rich toffee, caramel, dark chocolate, and spice. A premium sipper and cocktail mixer for Old Fashioned and Mai Tai.", related: ["Diplomático Reserva Exclusiva", "Mount Gay XO", "Plantation XO"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ron_Zacapa_Centenario_23_anos.jpg" },
    { name: "Havana Club 7 Años", description: "Cuban dark rum aged 7 years. Smooth, complex, with notes of vanilla, caramel, tobacco, and oak. Perfect for Mojito, Cuba Libre, and aged rum cocktails.", related: ["Flor de Caña 7", "Myers's Original Dark", "Gosling's Black Seal"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/2023_Havana_Club_A%C3%B1ejo_7_A%C3%B1os_%283%29.jpg" }
  ] },
  ...
  bottles: [
        ...
        { name: "Flor de Caña 12", description: "Nicaraguan aged rum from the Flor de Caña distillery. 12-year-old, ultra-smooth, with rich caramel, vanilla, oak, and toasted almond. The flagship expression of one of Central America's most iconic rum brands.", related: ["Flor de Caña 7", "Diplomático Reserva Exclusiva", "Mount Gay XO"] },
        { name: "Mount Gay Eclipse", description: "Barbadian aged rum from Mount Gay Distillery. A blend of rums aged 4–8 years in American oak and ex-bourbon barrels. Smooth, balanced, with vanilla, caramel, toffee, and subtle spice. A versatile mixer for rum Old Fashioned and Daiquiri.", related: ["Mount Gay XO", "Diplomático Reserva Exclusiva", "Flor de Caña 7"] },
        { name: "Diplomático Mantuano", description: "Venezuelan aged rum from Diplomático. A rich blend of rums aged up to 8 years. Deep molasses, dark chocolate, dried fruit, and spice. Complex and full-bodied — the robust sibling to Reserva Exclusiva.", related: ["Diplomático Reserva Exclusiva", "Diplomático Planas", "Ron Zacapa 23"] },
        { name: "El Dorado 15 Year", description: "Guyanese aged rum from El Dorado Distillery. Aged 15 years in ex-bourbon barrels. Extraordinarily rich with deep molasses, caramel, vanilla, dark chocolate, and spice. A luxurious sipper and premium cocktail rum.", related: ["El Dorado 12 Year", "Zacapa 23", "Plantation 5 Year"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/El_Dorado_Rum.JPG" },
        { name: "Appleton Estate 12 Year", description: "Jamaican aged rum from Appleton Estate. Aged 12 years in American oak ex-bourbon barrels. Rich, full-bodied, with tropical fruit, molasses, oak, and warm spice. A classic Jamaican aged rum for rum Old Fashioned and sipping.", related: ["Appleton Estate Overproof Rum", "Hamilton 151", "Lemon Hart 151"] },
        { name: "Brugal 1888", description: "Dominican aged rum from Brugal. A premium solera-aged rum with rich molasses, caramel, vanilla, and spice. Smooth, complex, and perfect for sipping or premium cocktails.", related: ["Brugal Añejo", "Brugal Blanco", "Bacardi 8"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Brugal_dominican_rum.jpg" },
        { name: "Mount Gay Black Barrel", description: "Barbadian aged rum from Mount Gay Distillery. Aged in American oak and finished in toasted bourbon barrels. Rich toffee, vanilla, spice, and dark chocolate. A sophisticated mixer for rum Old Fashioned and Manhattan variations.", related: ["Mount Gay XO", "Mount Gay Eclipse", "Plantation 5 Year"] },
        { name: "Ron Abuelo 7 Year", description: "Philippine aged rum from Ron Abuelo. Aged 7 years in American oak barrels. Smooth, balanced, with vanilla, caramel, and tropical fruit notes. A distinctive Asian aged rum for rum Old Fashioned and tropical cocktails.", related: ["Ron Abuelo 12 Year", "Tres Cuatro y Cinco", "Flor de Caña 7"] },
        { name: "Hampden Estate 8 Year", description: "Jamaican aged rum from Hampden Estate. Aged 8 years in ex-bourbon barrels. Funky, complex, with tropical fruit, molasses, and oak. A craft cocktail staple for Ti' Punch and rum Old Fashioned.", related: ["Hampden The Maverick", "Appleton Estate 12 Year", "Worthy Park 11 Year"] }
  ]
},
  { name: "Overproof rum", category: "Rums", description: "High-ABV rum (57%+ / 114 proof+). Intense, fiery, used in small dashes in Tiki and flaming cocktails.", brands: ["Wray & Nephew Overproof", "Lemon Hart 151", "Plantation O.F.T.D.", "Hamilton 151"], notes: "Use ¼–½ oz dashes. Flaming Dr. Pepper, Zombie.", bottles: [
    ...
    { name: "El Dorado 151 Overproof Rum", description: "Guyanese overproof rum from El Dorado Distillery. Bottled at 75.5% ABV (151 proof). Bold, intense, with deep molasses, tropical fruit, and spice. A fiery overproof for Tiki and flaming cocktails.", related: ["Wray & Nephew Overproof", "Hamilton 151", "Lemon Hart 151"] },
    { name: "Worthy Park Overproof", description: "Jamaican overproof rum from Worthy Park Estate. The first Jamaican overproof rum crafted from a blend of both molasses and cane juice distillates. Bold, funky, with tropical fruit and spice. 63% ABV. A craft cocktail staple for Ti' Punch and Tiki drinks.", related: ["Wray & Nephew Overproof", "Appleton Estate Overproof Rum", "Hampden Estate Overproof Rum"] },
    { name: "Hampden Estate Overproof Rum", description: "Jamaican overproof rum from Hampden Estate. A blend of rums aged for 7 years, bottled at 60% ABV. Intense, funky, with tropical fruit, molasses, and oak. A craft favorite for Ti' Punch and Jungle Bird variations.", related: ["Wray & Nephew Overproof", "Appleton Estate Overproof Rum", "Pusser's Navy Rum"] }
  ] },
  ...
  bottles: [
        ...
        { name: "Tanqueray No. Ten", description: "Premium London dry gin from Tanqueray. Distilled ten times with fresh citrus botanicals including grapefruit and lime. Crisp, clean, and complex. 47.3% ABV. The upscale choice for martinis and sophisticated G&Ts.", related: ["Tanqueray London Dry", "Tanqueray Rangpur", "Beefeater London Dry"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Tanqueraybottles.jpg" },
        { name: "Bombay Bramble", description: "British gin from Bombay Sapphire with wild blackberry and raspberry infusions. Vibrant, fruity, with juniper and citrus. 37.5% ABV. A colorful, modern twist on classic London dry for Gin & Tonic and Bramble cocktails.", related: ["Bombay Sapphire", "Beefeater London Dry", "Tanqueray London Dry"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Bombay_Sapphire_Bramble_Gin_02.jpg" },
        { name: "Gordon's London Dry", description: "The original London dry gin from Gordon's, established 1769. Triply distilled with juniper, coriander, angelica, and liquorice. Crisp, clean juniper profile. 37.5% ABV. The quintessential gin for martinis and G&Ts.", related: ["Beefeater London Dry", "Tanqueray London Dry", "Bombay Sapphire"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Gordon%27s_Gin_cropped.jpg" },
        { name: "The Botanist", description: "Artisanal dry gin from the Isle of Islay, Scotland. 22 hand-foraged local botanicals including juniper, mint, and heather. Complex, aromatic, and distinctive. 46% ABV. A sipping gin or for layered cocktails.", related: ["Hendrick's Gin", "Plymouth Gin", "Tanqueray No. Ten"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/The_Botanist_Islay_Dry_Gin_03.tif" }
  ,
        { name: "Roku Gin", description: "Japanese craft gin from Suntory. Six Japanese botanicals including yuzu, sakura flower, sencha tea, and gyokuro tea. Smooth, complex, with citrus, floral, and subtle tea notes. 43% ABV. A distinctive Japanese gin for Gin & Tonic and martini variations.", related: ["Hendrick's Gin", "The Botanist", "Tanqueray No. Ten"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Roku_Gin.jpg" }
  ,
        { name: "Elephant Gin", description: "African craft gin from Germany. Distilled with organic botanicals and elephant-inspired ingredients. Smooth, complex, with juniper, citrus, and African spice notes. 45% ABV. A craft gin with a conservation story — a portion of proceeds supports elephant conservation.", related: ["Hendrick's Gin", "The Botanist", "Monkey 47"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Elephant_GIN.jpg" }
  ,
  ...
  bottles: [
        ...
        { name: "Tanqueray Rangpur", description: "London dry gin from Tanqueray infused with Rangpur lime. Distinctive citrus-forward profile with zesty, spicy lime character. 43.1% ABV. A refreshing twist on classic London dry for G&Ts and citrus-forward cocktails.", related: ["Tanqueray London Dry", "Tanqueray No. Ten", "Beefeater London Dry"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Rangpurgin.jpg" },
        { name: "Sloane's Gin", description: "Belgian craft gin from Sloane's Distillery. Smooth, balanced, with juniper, citrus, and subtle spice. 44% ABV. A modern European expression for Martinis and G&Ts.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Sloane%27s_Gin_Bottle.jpg" },
        { name: "Victoria Gin", description: "Craft gin from Victoria Distillers in British Columbia, Canada. Juniper-forward with Pacific Northwest botanicals. Smooth, clean, with citrus and herbal notes. 44% ABV. A Canadian craft expression for Martini and Negroni.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/VictoriaGin_bottle_750ml.jpg" },
        { name: "Broker's Gin", description: "English London dry gin with a distinctive blue bottle and wax seal. Juniper-forward with citrus and spice. 40% ABV. A classic, reliable choice for Martinis and G&Ts with a touch of British flair.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Broker%27s_Gin_bottle.JPG" },
        { name: "Sipsmith London Dry Gin", description: "Award-winning London dry gin from Sipsmith Distillery in London. Handcrafted in small batches with 10 botanicals including juniper, coriander, angelica, and liquorice. Crisp, clean, juniper-forward. 41.6% ABV. The first copper-pot London dry gin since 1820.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"] },
        { name: "Four Pillars Rare Dry Gin", description: "Australian craft gin from Four Pillars Distillery in Yarra Valley. Juniper-forward with native Australian botanicals including lemon myrtle and pepperberry. Complex, aromatic, and distinctive. 41.8% ABV. A Southern Hemisphere craft gin for modern cocktails.", related: ["Tanqueray London Dry", "The Botanist", "Hendrick's Gin"] },
        { name: "Fords Gin", description: "London dry gin from Fords Distillery in Kings Cross, London. Nine botanicals including juniper, coriander, angelica, and Seville orange. Smooth, balanced, with citrus and spice. 40% ABV. A modern London dry crafted for the perfect Martini.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Plymouth Gin"] },
        { name: "Seagram's Extra Dry Gin", description: "Classic American dry gin from Seagram's. Clean, juniper-forward with citrus and spice. 40% ABV. A widely available workhorse for Martinis and mixed drinks.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Seagram%27s_Extra_Dry_Gin_(53074621048).jpg" },
        { name: "Boodles London Dry Gin", description: "English London dry gin from Boodles. Distinctive coriander-forward botanicals with juniper, angelica root, cassia, and liquorice. Smooth, balanced, with citrus and spice. 40% ABV. A classic British gin for Martinis and G&Ts.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"] },
        { name: "Sacred London Dry Gin", description: "Award-winning London dry gin from Sacred Distillery in Highgate, London. Handcrafted in small batches with juniper, coriander, angelica, and liquorice. Crisp, clean, juniper-forward. 42% ABV. A modern London dry from London's first copper-pot distillery since the 1800s.", related: ["Tanqueray London Dry", "Beefeater London Dry", "Bombay Sapphire"] },
        { name: "Tanqueray Flor De Sevilla", description: "London dry gin from Tanqueray infused with Seville oranges. Distinctive orange-forward profile with juniper, coriander, angelica root, and liquorice. 41.3% ABV. A refreshing citrus twist on classic London dry for G&Ts and Negroni variations.", related: ["Tanqueray London Dry", "Tanqueray No. Ten", "Beefeater London Dry"] },
  ] },
 ...
 ,
  ...
  bottles: [
        ...
        { name: "Patrón Reposado", description: "Premium 100% blue agave reposado aged up to 12 months in oak barrels. Smooth, sweet agave with vanilla, caramel, and light oak. The well-rounded middle sibling of the Patrón lineup for Margarita variations.", related: ["Patrón Silver", "Patrón Añejo", "Don Julio Reposado"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/PatronGoldBottle.jpg" },
        { name: "Espolòn Reposado", description: "100% blue agave reposado from Jalisco. Aged in American oak barrels. Smooth agave with vanilla, caramel, and pepper. Great value reposado for Margaritas and sipping.", related: ["Espolòn Blanco", "Patrón Reposado", "Fortaleza Reposado"] },
        { name: "Herradura Silver", description: "100% blue agave blanco from Casa Herradura in Jalisco. Bright, crisp agave with pepper and citrus. A classic, widely available Mexican blanco for Margaritas and shots.", related: ["Herradura Reposado", "Herradura Añejo", "Patrón Silver"] },
        { name: "818 Tequila", description: "100% blue agave tequila from Jalisco, co-founded by Kevin Hart. Bright, crisp agave with pepper and citrus. A modern, widely distributed tequila for Margaritas and shots.", related: ["Patrón Silver", "Espolòn Blanco", "Fortaleza Blanco"] },
        { name: "Clase Azul Reposado", description: "Premium 100% blue agave reposado from Jalisco. Aged in American oak barrels. Rich, smooth agave with vanilla, caramel, and oak. Known for its distinctive ceramic decanter. A luxury reposado for sipping and premium cocktails.", related: ["Patrón Reposado", "Don Julio 1942", "Casamigos Reposado"] },
        { name: "Herradura Añejo", description: "100% blue agave añejo tequila from Casa Herradura in Jalisco. Aged 25 months in American oak barrels. Rich, complex agave with vanilla, caramel, dark chocolate, and toasted oak. A luxury sipping añejo.", related: ["Herradura Reposado", "Herradura Silver", "Patrón Añejo"] },
        { name: "El Tesoro Reposado", description: "100% blue agave reposado from La Alteña distillery in Jalisco. Aged 8–10 months in ex-bourbon barrels. Bright, clean agave with vanilla, citrus, and pepper. A traditional, artisanal reposado.", related: ["El Tesoro Añejo", "Fortaleza Reposado", "Patrón Reposado"] },
        { name: "Fortaleza Añejo", description: "100% blue agave añejo from the Fortaleza distillery in Jalisco. Aged 12–18 months in American oak. Rich, complex agave with vanilla, caramel, oak, and spice. A premium añejo for sipping or premium cocktails.", related: ["Fortaleza Reposado", "Fortaleza Blanco", "Don Julio 1942"] },
        { name: "Espolòn Añejo", description: "100% blue agave añejo from Jalisco. Aged in American oak barrels. Smooth, rich agave with vanilla, caramel, oak, and subtle spice. Great value añejo for sipping or premium cocktails.", related: ["Espolòn Reposado", "Espolòn Blanco", "Patrón Añejo"] },
         { name: "Casa Noble Reposado", description: "Premium 100% blue agave reposado from Casa Noble distillery in Jalisco. Aged in French and American oak barrels. Smooth, elegant agave with vanilla, caramel, and light oak. A premium reposado for sipping or premium cocktails.", related: ["Casa Noble Blanco", "Casa Noble Añejo", "Fortaleza Reposado"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Casa_Noble_tequila.jpg" },
         { name: "Olmeca Blanco", description: "100% blue agave blanco tequila from Olmeca. Bright, crisp agave with pepper, citrus, and earthy notes. A widely available, value-oriented Mexican blanco for Margaritas and shots.", related: ["Olmeca Reposado", "Patrón Silver", "Espolòn Blanco"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Olmeca_Tequila_by_CorneliusA_2015.jpg" },
         { name: "Herradura Ultra", description: "100% blue agave reposado from Casa Herradura in Jalisco. Extra-aged for extended smoothness. Rich agave with vanilla, caramel, oak, and subtle spice. A premium expression in the Herradura lineup.", related: ["Herradura Reposado", "Herradura Añejo", "Fortaleza Reposado"] },
         { name: "Don Julio 70", description: "Premium 100% blue agave tequila from Casa Don Julio in Jalisco. Aañejo Claro expression — aged then filtered to remove color. Rich cooked agave with vanilla, caramel, oak, and pepper. Versatile for sipping or premium cocktails.", related: ["Don Julio 1942", "Don Julio Blanco", "Patrón Añejo"] },
         { name: "Tapatío", description: "100% blue agave tequila from the La Alteña distillery in Jalisco. Bold, intense agave with pepper, citrus, and earth. A cult favorite among tequila enthusiasts for its authenticity and value. Known as \"El Tao\" in Mexico.", related: ["Fortaleza Blanco", "Patrón Silver", "Sauza Blanco"] },
    { name: "Don Julio Reposado", description: "Premium 100% blue agave reposado tequila from Casa Don Julio in Jalisco. Aged 8–12 months in American oak barrels. Smooth, balanced agave with vanilla, caramel, and light oak. A versatile, widely available reposado for Margaritas and sipping.", related: ["Don Julio Blanco", "Don Julio 1942", "Patrón Reposado"] },
    { name: "Patrón Añejo", description: "Premium 100% blue agave añejo tequila from Patrón. Aged at least 12 months in American oak barrels. Rich, complex agave with vanilla, caramel, dark fruit, and toasted oak. A luxury sipping añejo for premium cocktails.", related: ["Patrón Silver", "Patrón Reposado", "Don Julio 1942"] },
    { name: "Casamigos Añejo", description: "Premium 100% blue agave añejo tequila from Casamigos. Aged 14–18 months in American oak barrels. Smooth, sweet agave with vanilla, caramel, and light oak. A premium sipping añejo from the George Clooney-founded brand.", related: ["Casamigos Blanco", "Casamigos Reposado", "Don Julio 1942"] },
    { name: "Jose Cuervo Tradicional", description: "100% blue agave tequila from Jose Cuervo. The traditional expression from the world's most popular tequila brand. Smooth, balanced agave with pepper, citrus, and light oak. A reliable, widely available mixer for Margaritas and shots.", related: ["Jose Cuervo Especial Silver", "Jose Cuervo Gold", "Patrón Silver"] },
  ]
},
  ...
  ,
    { name: "Torani Grenadine", description: "American grenadine from Torani. Deep red pomegranate syrup, commonly used in cocktails and soda fountains. A widely available mixer for Tequila Sunrise and Shirley Temple.", related: ["Monin Grenadine", "Roses Grenadine", "Fee Brothers Grenadine"] }
  ,
    { name: "1883 Grenadine", description: "French grenadine from 1883. Rich pomegranate syrup with balanced sweet-tart profile. A premium cocktail mixer used in bars worldwide.", related: ["Monin Grenadine", "Roses Grenadine", "Fee Brothers Grenadine"] }
  ,
    { name: "DaVinci Gourmet Grenadine", description: "American grenadine from DaVinci Gourmet. Vibrant red pomegranate syrup for cocktails and mocktails. A staple in coffeehouse and bar syrup lines.", related: ["Monin Grenadine", "Roses Grenadine", "Fee Brothers Grenadine"] }
  ,
    { name: "Stirrings Grenadine", description: "American grenadine from Stirrings. Authentic pomegranate syrup with no artificial colors. A craft cocktail mixer favored by bartenders.", related: ["Monin Grenadine", "Roses Grenadine", "Fee Brothers Grenadine"] }
  ]
},
  ...
  bottles: [
    ...
    { name: "Giffard Maraschino", description: "French maraschino liqueur from Giffard. Made from Marasca cherries with rich cherry, almond, and spice notes. A versatile liqueur for classic cocktails.", related: ["Luxardo Maraschino", "Maraska Maraschino", "Bols Maraschino"] },
    { name: "Briottet Maraschino", description: "French maraschino liqueur from Briottet of Dijon. Crafted from Marasca cherries with balanced cherry and nutty almond character. A traditional expression from a historic French liqueur house.", related: ["Luxardo Maraschino", "Maraska Maraschino", "Bols Maraschino"] },
    { name: "Hiram Walker Maraschino", description: "American maraschino liqueur from Hiram Walker. Made from Marasca cherry pits with distinctive cherry and spice notes. A classic mixer for cocktails like the Aviation and Martinez.", related: ["Luxardo Maraschino", "Maraska Maraschino", "Bols Maraschino"] }
  ]
},
  ...
  bottles: [
    ...
    { name: "Patrón Citronge", description: "Patrón's orange liqueur. Made with Patrón tequila and aged in oak barrels. Bright, clean orange flavor with a hint of vanilla. 35% ABV.", related: ["Cointreau", "Grand Marnier", "Pierre Ferrand Dry Curaçao"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Patron_citronge.jpg" },
    { name: "Grand Marnier", description: "Premium French orange liqueur made from Cognac and distilled essence of bitter orange. Rich, complex flavor with notes of orange, vanilla, and oak. 40% ABV.", related: ["Cointreau", "Patrón Citronge", "Pierre Ferrand Dry Curaçao"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Grand_Marnier_Bottle.jpg" },
    { name: "Grand Marnier Cuvée Louis-Alexandre", description: "Premium Grand Marnier expression honoring Louis-Alexandre Marnier Lapostolle. Rich orange and Cognac flavors with a long, warming finish. 40% ABV.", related: ["Grand Marnier", "Cointreau", "Patrón Citronge"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Grand_Marnier_Cuv%C3%A9e_Louis-Alexandre.jpg" },
    { name: "Hiram Walker Triple Sec", description: "American triple sec liqueur from Hiram Walker. Clean, bright orange flavor. A versatile and affordable mixer for cocktails.", related: ["Cointreau", "DeKuyper Triple Sec", "Bols Triple Sec"] },
    { name: "DeKuyper Triple Sec", description: "Dutch triple sec liqueur from DeKuyper. Sweet, clean orange flavor. A popular and affordable mixer for cocktails like Margaritas and Cosmos.", related: ["Cointreau", "Hiram Walker Triple Sec", "Bols Triple Sec"] }
  ]
},
  ...
  ,
    ...
    { name: "Marie Brizard Elderflower Liqueur", description: "French elderflower liqueur from Marie Brizard. Floral, sweet, with honey and citrus notes. 20% ABV. A classic European elderflower liqueur for cocktails.", related: ["St-Germain", "Monin Elderflower Liqueur", "Giffard Crème de Sureau"] },
    { name: "Hiram Walker Elderflower Liqueur", description: "Elderflower liqueur from Hiram Walker. Floral, sweet, with honey and subtle citrus. 20% ABV. An accessible elderflower liqueur for mixed drinks.", related: ["St-Germain", "Monin Elderflower Liqueur", "Giffard Crème de Sureau"] },
    { name: "Bols Elderflower Liqueur", description: "Dutch elderflower liqueur from Bols. Floral, sweet, with honey and lychee undertones. 20% ABV. A versatile mixer for elderflower cocktails.", related: ["St-Germain", "Monin Elderflower Liqueur", "Giffard Crème de Sureau"] }
  ] },
  ...
  bottles: [
    ...
    { name: "Amaro Lucano", description: "Italian amaro from Basilicata, produced by the Lucano family since 1894. Bitter-sweet with herbal, citrus, and root notes. 28% ABV. A classic digestif served neat or on ice.", related: ["Fernet-Branca", "Amaro Averna", "Amaro Montenegro"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Amaro_Lucano_Bottle.jpg" },
    { name: "Vecchio Amaro del Capo", description: "Calabrian amaro produced since 1866. Bitter-sweet with juniper, mint, and citrus. 35% ABV. The flagship amaro from the Campidano distillery.", related: ["Fernet-Branca", "Amaro Averna", "Amaro Montenegro"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Vecchio_Amaro_del_Capo_01.JPG" },
    { name: "Amaro Sibilla", description: "Italian amaro from the Sibilla distillery. Bitter-herbal with honeyed sweetness and aromatic botanicals. 30% ABV. A balanced sipping amaro from the Sibillion hills.", related: ["Fernet-Branca", "Amaro Averna", "Amaro Montenegro"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Amaro_Sibilla.jpg" },
    { name: "Unicum", description: "Hungarian herbal digestif liqueur made with more than forty herbs and spices. Intensely bitter, complex, best served cold and straight up. 40% ABV. The national shot of Hungary.", related: ["Fernet-Branca", "Jägermeister", "Underberg"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Unicum%3B_The_National_Shot_of_Hungary_(8035954926).jpg" },
    { name: "Amaro 18 Isolabella", description: "Italian amaro from Isolabella, produced since 1887. Bitter-sweet with orange peel, vanilla, and 18 botanicals. 30% ABV. A refined, well-balanced amaro for sipping or stirred cocktails.", related: ["Fernet-Branca", "Amaro Averna", "Amaro Montenegro"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Amaro_18_Isolabella%2C_bottle.jpg" }
  ]
},
  ...
  bottles: [
    ...
    { name: "Bitter Truth Aromatic Bitters", description: "German-made aromatic bitters. Similar herbal profile to Angostura with gentian root, spices, and herbs. 39% ABV. A quality alternative for stirred cocktails.", related: ["Peychaud's Aromatic Bitters", "Angostura Aromatic Bitters"] },
    { name: "Scrappy's Aromatic Bitters", description: "American craft aromatic bitters. Bright, complex profile with citrus and spice notes. A versatile modifier for cocktails calling for Peychaud's or Angostura.", related: ["Peychaud's Aromatic Bitters", "Bittermens Boston Bitters"] },
    { name: "Fee Brothers Old Fashioned Bitters", description: "American aromatic bitters from Fee Brothers with notes of allspice, clove, and citrus peel. A classic aromatic bitters for Old Fashioneds and Manhattan variations.", related: ["Peychaud's Aromatic Bitters", "Bitter Truth Aromatic Bitters"] },
  ...
  bottles: [
    ...
    { name: "Tio Pepe Fino En Rama", description: "Unfiltered, unrefined version of Tio Pepe Fino, released annually in limited quantities. Richer, more vibrant fino character with intense saline, yeast, and almond notes. The purist's choice for Tio Pepe.", related: ["Tio Pepe Fino", "Lustau Fino En Rama", "Barbadillo Fino"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/TioPepe-Mosto-DSC01550.JPG" },
    { name: "Lustau Fino En Rama", description: "Unfiltered Lustau Fino released in limited En Rama batches. Vibrant, fresh fino with pronounced yeast, saline, and green apple notes. A more intense expression than standard Lustau Fino.", related: ["Lustau Fino", "Tio Pepe Fino En Rama", "Valdespino Fino"] },
    { name: "Barbadillo Fino", description: "Fino sherry from Bodegas Barbadillo in Sanlúcar de Barrameda. Pale, dry, saline, with fresh yeast and almond notes. A classic manzanilla-producing bodega with a distinctive fino.", related: ["Tio Pepe Fino", "Lustau Fino", "La Gitana Manzanilla"] },
    { name: "El Maestro Sierra Fino", description: "Fino sherry from El Maestro Sierra, a traditional Jerez bodega. Pale, dry, saline, with refined almond and green apple notes. Produced in small quantities using traditional solera methods.", related: ["Tio Pepe Fino", "Lustau Fino", "Valdespino Fino"] },
    { name: "Sanchez Romate Fino", description: "Fino sherry from Bodegas Sánchez Romate. Pale, dry, saline, with clean yeast and almond notes. One of Jerez's historic bodegas, also known for their NPU Amontillado.", related: ["Tio Pepe Fino", "Lustau Fino", "Gonzalez Byass Fino"] }
  ]
},
  ...
  { name: "Falernum", category: "Other Spirits", description: "Caribbean syrup-spice liqueur. Almond, ginger, clove, allspice. Sweet, warm, 11% ABV.", brands: ["Fee Brothers Falernum", "Old Professor Falernum", "Romilly's"], notes: "Tiki Punch, Scorpion, certain Mai Tai recipes.", bottles: [
    ...
    { name: "John D. Taylor's Velvet Falernum", description: "Barbadian falernum liqueur from Foursquare Rum Distillery. Thick, velvety texture with clove-forward warmth. The canonical commercial falernum for Tiki cocktails.", related: ["The Bitter Truth Golden Falernum", "Old Judge Falernum Special Reserve"] },
    { name: "The Bitter Truth Golden Falernum", description: "German-made golden falernum liqueur from The Bitter Truth. Lime and ginger-forward with 18% ABV. More spirit-forward than syrupy alternatives.", related: ["John D. Taylor's Velvet Falernum", "Old Judge Falernum Special Reserve"] },
    { name: "Old Judge Falernum Special Reserve", description: "Austrian-Barbadian falernum liqueur from Old Judge Spirits. Special Reserve expression with 3 selected rums from Barbados and Jamaica. Spice liqueur rated 94 Falstaff points.", related: ["John D. Taylor's Velvet Falernum", "The Bitter Truth Golden Falernum"] },
    { name: "Tippleman's Double Spiced Falernum Syrup", description: "Craft falernum syrup from Tippleman's. Double spiced with fresh whole spices, citrus peel, and ginger. Non-alcoholic cocktail mixer for Tiki drinks.", related: ["John D. Taylor's Velvet Falernum", "Fee Brothers Falernum"] }
  ] },
  ...
  ,
    ...
    { name: "Sapucaia Cachaça", description: "Historic Brazilian cachaça from Pirassununga, São Paulo. One of the oldest cachaça brands (founded 1933). Smooth, balanced sugarcane spirit with subtle oak influence from barrel aging. A classic choice for Caipirinha.", related: ["Leblon Cachaça", "Ypióca Cachaça", "51 Cachaça"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Garrafa_Cacha%C3%A7a_Sapucaia_de_1933.jpg" },
    { name: "Seleta Cachaça", description: "Premium Brazilian cachaça from Minas Gerais. Artisanal, smooth sugarcane spirit with a clean, bright profile. Well-suited for premium Caipirinha and tropical cocktails.", related: ["Leblon Cachaça", "Novo Fogo Cachaça", "Ypióca Cachaça"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Seleta_cachaca_flaska.JPG" },
    { name: "Cachaça Divininha", description: "Brazilian cachaça from Minas Gerais. Smooth, clean sugarcane spirit with a balanced, approachable profile. A reliable mixer for Caipirinha and batidas.", related: ["Leblon Cachaça", "Ypióca Cachaça", "51 Cachaça"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/CachacaDivininha.jpg" },
    { name: "Cachaça Rainha da Lavoura", description: "Brazilian cachaça with a smooth, refined sugarcane character. Clean and balanced, with subtle herbaceous notes. A versatile mixer for Caipirinha and tropical drinks.", related: ["Leblon Cachaça", "Avuá Cachaça", "Novo Fogo Cachaça"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Cacha%C3%A7a_Rainha_da_Lavoura.jpg" }
  ] },
